...
public class VirtualJoystick : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (VirtualJoystick.padRadius / distance > 3.5f) VirtualJoystick.movement = Vector2.zero;
        else
        {
            VirtualJoystick.movement = direction.normalized;
            if (VirtualJoystick.padRadius / distance > 1.5f) VirtualJoystick.movement /= 2.0f;
        }
    }
